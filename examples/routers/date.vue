...
<template>
    <div style="width: 500px;margin: 100px;">
        ...
        <DatePicker type="datetime" :time-picker-options="{min:[8,0,0]}" confirm placeholder="Select date" style="width: 400px"></DatePicker>
        <Time-Picker :steps="[1, 1, 15]" :min="[8,0,0]" :value="new Date()"></Time-Picker>
